...
def F_EnvironmentSelect(Population,FunctionValue,N):
    ...
    # _, MaxFront_temp = F_NDSort(FunctionValue_temp, 'all')
    MaxFront_temp=[]
    return Population_temp, FunctionValue_temp, FrontValue_temp, CrowdDistance_temp, MaxFront_temp
